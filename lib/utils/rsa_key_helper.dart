...
class RsaKeyHelper {
  ...
  /// Decode Public key from PEM Format (Governed by RFCs, its used preferentially by open-source software. It can have a variety of extensions (.pem, .key, .cer, .cert, more))
  ///
